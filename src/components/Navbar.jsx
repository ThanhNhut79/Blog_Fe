...
const Navbar = () => {
  ...
  return (
    <div className="bg-red-400 flex items-center justify-between px-6 md:px-[200px] py-4 sticky top-0">
      <h1 className="logo">
        <Link to="/">VN Blogger</Link>
      </h1>
      {path === "/" && (
        <div className="flex justify-center items-center space-x-0 relative">
          <input
            onChange={(e) => setPrompt(e.target.value)}
            className="outline-none pl-3 pr-40 h-10"
